...
class AppThemes {
  ...
  static const Color ebonyClay = Color.fromRGBO(37, 38, 43, 1);
  ...
  static const Color _darkPrimaryColor = Color.fromRGBO(117, 26, 33, 1);
  ...
  static final TextTheme _lightTextTheme = TextTheme(
    ...
    headline6: TextStyle(
        fontSize: 30.0, color: _darkTextColor, fontWeight: FontWeight.w600),
...
//text theme for dark theme
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    // accentColor: Colors.white, //prefix icon color form input on focus
