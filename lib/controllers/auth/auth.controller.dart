...
class AuthController extends GetxController {
  ...
  void handleAuthChanged(User _firebaseUser) {
  ...
  FutureOr<UserModel> getFirestoreUser() async {
    if (firebaseUser?.value?.uid != null) {
      return _db
  ...
  Future<void> sendSignInWithEmailLink(BuildContext context,
  ...
  Future<void> signInWithEmailLink(String link) async {
    try {
      final String signInEmail =
          (await GetStorage().read('signInEmail')).toString();
      if (signInEmail != null) {
